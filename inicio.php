  ...
  <div class="container-fluid">
    ...
    <div class="quick-actions_homepage">
      <ul class="quick-actions">
        <li class="bg_lg span3"> <a > <i class="icon-signal"></i> <h2>Smart  Soluciones</h2></a> </li>

        <li class="bg_lr"> <a> <i class="icon-pencil"></i> <H2>Deposito La Torre</H2></a> </li>
        <li class="bg_lg span3"> <a > <i class="icon-signal"></i> <h2>Sistema de Ventas</h2></a> </li>
      </ul>
    </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content">
            <div class="error_ex">
              <h1>BIENVENIDO</h1>
              <h3>Un sistema Web para un  control de Ventas ,Clientes, Empleados y Proveedores con reportes por día y mes de las ventas realizadas.</h3>
              </div>
          </div>
        </div>
      </div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> SmartSoluciones &copy; StuarBD </div>
</div>
