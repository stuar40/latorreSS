        ...
        <div class="widget-content nopadding">
          ...
          <form action="" method="post" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nombre" type="text" class="span11" placeholder="Nombre Servicio" />
              </div>
            </div>          
...
$query = "SELECT * FROM servicio WHERE nom_serv LIKE'$C2'";
...
?>
     ...
     <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="EliminarServicio.php" method="post" class="form-horizontal">

                      
             <div class="control-group">
              <label class="control-label">Id Servicio:</label>
              <div class="controls">
                <input name="id" value="<?php echo $dato['id_servicio']?>" type="text" class="span11" placeholder="Id Servicio" />
              </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label">Nombre Servicio:</label>
              <div class="controls">
                <input name="nombre" value="<?php echo $dato['nom_serv']?>" type="text" class="span11" placeholder="Nombre Servicio" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="descripcion" value="<?php echo $dato['descripcion_serv']?>" class="span11" placeholder="Descripción Servicio"/>
              </div>
            </div>
              ...
              <div class="controls">
                <input name="precio" value="<?php echo $dato['precio_serv']?>" type="text" class="span11" placeholder="Precio" />
              </div>
            </div> 
