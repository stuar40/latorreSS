...
<div class="container">
  <div class="panel panel-info">
    <div class="panel-heading">
      <h4><i class='glyphicon glyphicon-edit'></i> Facturar Servicio</h4>
    </div>
    ...
    ?>
      ...
      <form class="form-horizontal" role="form" id="datos_factura3">
        ...
        <div class="col-md-12">
          <div class="pull-right">
            ...
            <button type="button" class="btn btn-default" data-toggle="modal" data-target="#myModal2">
             <span class="glyphicon glyphicon-search"></span> Seleccionar Servicio
            </button>
