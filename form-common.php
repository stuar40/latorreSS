...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="inicio.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="tip-bottom">Elementos del formulario</a> <a href="#" class="current">Nuevo Usuario</a>
  </div>
...
<div class="container-fluid">
  ...
  <script type="text/javascript">
    ...
    return false;
          ...
          <form  action="InsertarEmpleado.php" method="post" enctype="multipart/form-data" class="form-horizontal"
          onsubmit="return confirmation()">

            <div class="control-group">
              <label class="control-label">Nombres y Apellidos :</label>
              <div class="controls">
                <input type="text" name="Nombres" required="required" class="span11" placeholder="Nombres y Apellidos" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" required="required" name="DPI" class="span11" placeholder="DPI" />
              </div>

              <div class="control-group">
              <label class="control-label">NIT :</label>
              <div class="controls">
                <input type="text" name="NIT" required="required" class="span11" placeholder="NIT" />
              </div>
            </div>
            ...
            <!-- <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="Licencia" class="span11" placeholder="Licencia" />
              </div>
            </div>-->
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" name="Telefono" required="required" class="span11" placeholder="Teléfono"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Dirección :</label>
              <div class="controls">
                <input type="text" name="Direccion" required="required" class="span11" placeholder="Dirección" />
              </div>
            </div>
              ...
              <div class="controls">
                <input type="text" name="Correo" class="span11" placeholder="Dirección de Correo" />
              </div>

              <div class='form-group'>
                        <label class="control-label">Fecha Ingreso a la Empresa :</label>
                        <div class="controls">
                            <input type="text" name="FechaIngreso" required="required" class="span11" id='fecha_ingreso' placeholder='Fecha Ingreso a la Empresa'/>
                        </div>
                      </div>
...
<!--                <input type="text" name="Tipo" class="span11" required="required" placeholder="Tipo" />
-->
        ...
        <div class="control-group">
             <label class="control-label">Usuario</label>
                  <div class="controls">
                    <input id="Usuario" type="text" required="required" name="Usuario" placeholder="Campor Obligatorio" />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Contraseña</label>
                  <div class="controls">
                    <input id="password" type="password" required="required" name="Password" placeholder="Campo Obligatorio" />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label">Confirmar Contraseña</label>
                  <div class="controls">
                    <input id="password2" type="password" required="required" name="password2" placeholder="Campo Obligatorio" />
                  </div>
                </div>
              </div>
              ...
              <button type="submit" name="Cancelar" class="btn btn-danger">Cancelar
              </button>
              </div>
          </form>
