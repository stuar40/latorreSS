...
<div class="container-fluid">
  ...
  <script type="text/javascript">
    ...
    return false;
         ...
         <form action="Insertaringresoprod.php" method="POST"  class="form-horizontal">
            
            <div class="control-group">
              <label class="control-label">Código de Producto :</label>
              <div class="controls">
                <input name="codigo" type="text" class="span11" placeholder="Código de Producto" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="stockmax" type="text" required="required" class="span11" placeholder="Stock" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="preciocom" type="text" required="required" class="span11" placeholder="Precio_cos" />
              </div>
            </div>
              ...
              <div class="controls">
                <input name="precioven" type="text" required="required" class="span11" placeholder="Precio_Venta" />
              </div>
