...
<h6> Ingrese fecha para la busqueda</h6>
</br>
...
//	$FECHAINI = $SSDATE[2].$SSDATE[1].$SSDATE[0];
	...
	$strsql= "select  numero_venta,serie_venta,fecha_venta, totpagar_venta,empleados_id from venta where venta.fecha_venta='$FECHAINI'";
	//echo ('<h3>'.$strsql.'</h3>');
...
<table border="0" width="500" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="5" bgcolor="white"><CENTER><strong>REPORTE GENERAL DE VENTA DIARIA</strong></CENTER></td>
  </tr>
  <tr bgcolor="skyblue">
...
<h6> Ingrese nuevamente la fecha</h6>
<form class="form-horizontal" action="ReportePdf_VentaG_diaria.php" method="get">
<div class="control-group">
