...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="tip-bottom">Elementos del formulario</a> <a href="#" class="current">Nuevo Servicio</a> 
  </div>
...
<script type="text/javascript">
    ...
    return false;
          ...
          <form action="InsertarServicio.php" method="POST" class="form-horizontal" onsubmit="return confirmation()" >          
            <div class="control-group">
              <label class="control-label">Nombre Servicio:</label>
              <div class="controls">
                <input name="nombre" type="text" required="required" class="span11" placeholder="Nombre Servicio" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <textarea name="descripcion" class="span11" required="required" placeholder="Descripción Servicio"></textarea>
              </div>
            </div>
              ...
              <div class="controls">
                <input name="precio" type="text" required="required" class="span11" placeholder="Precio" />
              </div>
            </div>
