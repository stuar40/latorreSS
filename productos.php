...
<table width="90%" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="9" bgcolor="white"><CENTER><strong>PRODUCTOS</strong></CENTER></td>
  </tr>
  <tr bgcolor="skyblue">
   
  <td><CENTER><strong>COD.PRODUCTO</strong></CENTER></td> 
  <td><CENTER><strong>SERIE</strong></CENTER></td>
  <td><CENTER><strong>PRODUCTO</strong></CENTER></td>
	<td><CENTER><strong>DESCRIP.</strong></CENTER></td>
  <td><CENTER><strong>STOCK</strong></CENTER></td>
	<td><CENTER><strong>STOCK_MINIMO</strong></CENTER></td>
	<td><CENTER><strong>PRE.COSTO</strong></CENTER></td>
  <td><CENTER><strong>PRE.VENTA</strong></CENTER></td>
...
?>  
	<tr>
		<td><CENTER><?php echo $res['id_producto']; ?></CENTER> </td>
		<td><?php echo $res['serie_prod']; ?> </td>
		<td><?php echo $res['nom_prod']; ?> </td>
		<td><?php echo $res['descr_prod']; ?> </td>
		<td><CENTER><?php echo $res['stock_prod']; ?> </td>
		<td><CENTER><?php echo $res['stockmin_prod']; ?> </CENTER></td>
		<td><CENTER><?php echo $res['preciocosto_prod']; ?></CENTER> </CENTER></td>
    <td><CENTER><?php echo $res['preciovent_prod']; ?> </CENTER></td>
