...
?>	
	<tr>
		...
		<td><?php echo $res['nombre_emp']; ?> </td>
		<td><?php echo $res['nit_emp']; ?> </td>
		<td><?php echo $res['descripcion_emp']; ?> </td>
		<td><?php echo $res['dir_emp']; ?> </td>
		<td><?php echo $res['tel_emp']; ?> </td>
		<td><?php echo $res['email_emp']; ?> </td>
		<td><?php echo $res['pais_emp']; ?> </td>
...
<td width="145" align="center"><a href="ReportePdf_cliente.php"><img src="img/pdf.png" width="30" height="25"/></a></td>
</tr>
<tr>
<td><strong>REPORTE EN EXCEL</strong></td>
<td align="center"><a href="ReporteExcel_cliente.php"><img src="img/excel.png" width="30" height="25"/></a></td>
</tr>
