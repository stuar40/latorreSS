<?php
	...
	if($action == 'ajax'){
		// escaping, additionally removing everything that could be (html/javascript-) code
		 ...
		 $aColumns = array('id_servicio', 'nom_serv');//Columnas de busqueda
		 $sTable = "servicio";
		 $sWhere = "";
		if ( $_GET['q'] != "" )
		{
			...
			<div class="table-responsive">
			  <table class="table">
				...
				while ($row=mysqli_fetch_array($query)){
					...
					$nombre_servicio=$row['nom_serv'];
					$descripcion=$row['descr_serv'];
					//$stock=$row['stock_prod'];
					$precio_costo=$row['precio_serv'];
					...
					<tr>
						...
						<input type="text" class="form-control" style="text-align:right" id="precio_venta_<?php echo $id_servicio; ?>"  value="<?php echo $precio_costo;?>" >
						</div></td>
