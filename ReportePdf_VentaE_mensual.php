...
$pdf->Cell(40, 8, '', 0);
$pdf->Cell(100, 8, 'REPORTE VENTA MENSUAL - VENDEDOR', 0);
$pdf->Ln(15);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$sql = mysql_query("SELECT empleados_id,numero_venta,serie_venta,fecha_venta, totpagar_venta from venta WHERE empleados_id='$codigo' and  fecha_venta between '$fechaini' and '$fechafin' ");
$item = 0;
//$totaluni = 0;
$totalventa = 0;
...
$pdf->Cell(0,10,'Total Venta Mensual: Q. '.$totalventa.'.00',0);
$pdf->Output('ReporteVentaE_mensual.pdf','I');
?>