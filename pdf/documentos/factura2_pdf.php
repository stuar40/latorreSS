<?php
	...
	$sql=mysqli_query($con, "select LAST_INSERT_ID(idcompra) as last from compra order by idcompra desc limit 0,1");
	$rw=mysqli_fetch_array($sql);
	$numero_factura=$rw['last']+1;	
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/factura2_html.php');
