...
VALUES ('$numero_factura','s', '$numero_factura', '$date', '0', '0', '0', '$id_cliente', '$id_vendedor')");

///=====================
$nums=1;
$sumador_total=0;
$sql=mysqli_query($con, "select * from servicio, tmp where servicio.id_servicio=tmp.id_producto and tmp.session_id='".$session_id."'");
...
while ($row=mysqli_fetch_array($sql))
   ...
   $insert_detail=mysqli_query($con, "INSERT INTO detalle_venta (cantidad_dtventa,costo_dtventa, precio_dtventa, serieprod_dtventa, subtotal_dtventa, servicio_id, venta_id) 
	VALUES ('$cantidad', '$precio_venta', '$precio_venta', '$id_producto', '$precio_total', '$id_producto', '$numero_factura');");



	

	$kardex=mysqli_query($con,"INSERT INTO movimientos (tipo_mov, fecha_mov,cantidad_mov, precio_mov, motivo_mov, empleados_id, venta_idventa,servicio_id_servicio) 
	VALUES ('Servicio', '$date', '$cantidad', '$precio_total', '$nombre_producto', '$id_vendedor', '$numero_factura','$id_producto');");
