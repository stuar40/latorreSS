<?php
	...
	$sql=mysqli_query($con, "select LAST_INSERT_ID(idventa) as last from venta order by idventa desc limit 0,1");
	$rw=mysqli_fetch_array($sql);
	$numero_factura=$rw['last']+1;	
    // get the HTML
     ob_start();
     include(dirname('__FILE__').'/res/factura3serv_html.php');
