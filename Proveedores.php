...
<div id="content">
  ...
  <div id="breadcrumb"> <a href="inicio.php" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Inicio</a> <a href="#" class="tip-bottom">Elementos del formulario</a> <a href="#" class="current">Proveedor</a>
  </div>
...
<script type="text/javascript">
    ...
    return false;
          ...
          <form action="InsertarProveedor.php" method="post" class="form-horizontal" onsubmit="return confirmation()">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nit" type="text" required="required" class="span11" placeholder="Nit" />
              </div>
            </div>
              ...
              <div class="controls">
                <input name="direccion" type="text" required="required" class="span11" placeholder="Dirección" />
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input name="descripcion" type="text" class="span11" placeholder="Descripción" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="telefono" type="text" required="required"  class="span11" placeholder="Teléfono"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Dirección de Correo:</label>
              <div class="controls">
                <input name="correo" type="text" class="span11" placeholder="Dirección de Correo" />
              </div>
            </div>
