        ...
        <div class="widget-content nopadding">
          ...
          <form action="" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nombre" type="text" class="span11" placeholder="Nombre" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nit" type="text"  class="span11" placeholder="NIT"  />
              </div>
            </div>
...
// $Codigo = $_POST['codigo'];
 ...
 $query = "SELECT * FROM proveedores WHERE nom_prov LIKE'$Nombre' OR nit_prov LIKE'$Nit'";
     ...
     <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="EliminarProv.php" method="post" class="form-horizontal">

                      
                      <div class="control-group">
              <label class="control-label">Id Proveedor:</label>
              <div class="controls">
                <input name="codigo"  value="<?php echo $dato['id_proveedores']?> " type="text" required="required" class="span11" placeholder="Numero de Proveedor" />
              </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label">Nombre:</label>
              <div class="controls">
                <input name="nombre" value="<?php echo $dato['nom_prov'] ?> " type="text" required="required" class="span11" placeholder="Nombre" />
              </div>
            </div>
            ...
            <div class="control-group">
              <label class="control-label">Nit :</label>
              <div class="controls">
                <input name="nit" required="required" value="<?php echo $dato['nit_prov'] ?>" type="text" class="span11" placeholder="Nit" />
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input name="direccion" type="text" value="<?php echo $dato['dir_prov']?>" class="span11" placeholder="Dirección" />
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input name="descripcion" type="text" value="<?php echo $dato['decripcion_prov']?>" class="span11" placeholder="Descripcion" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="telefono" value="<?php echo $dato['tel_prov'] ?>" type="text"  class="span11" placeholder="Teléfono"  />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Dirección de Correo:</label>
              <div class="controls">
                <input name="correo" value="<?php echo $dato['email_prov'] ?>" type="text" class="span11" placeholder="Dirección de Correo" />
              </div>
            </div>
              ...
              <div class="controls">
                <input name="pais" value="<?php echo $dato['pais_prov'] ?>" type="text" class="span11" placeholder="País" />
              </div>
            </div>
