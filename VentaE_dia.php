...
<br>
<h2> REPORTE VENTA DIARIA POR VENDEDOR</h2>
<h6> Ingrese su codigo de vendedor y  fecha del dia</h6>
</br>
...
<div class="control-group">
              ...
              <label class="control-label">Ingrese fecha del dia :</label>
              <div class="controls">
...
//	$COD = $Codigo;
	...
	$strsql= "select  empleados_id, numero_venta,serie_venta,fecha_venta, totpagar_venta from venta where venta.empleados_id='$COD' and venta.fecha_venta='$FECHAINI'";
//	echo ('<h3>'.$strsql.'</h3>');
...
<h3> Generar Reporte del dia</h3>
<h6> Ingrese nuevamente el codigo y la fecha</h6>

<form class="form-horizontal" action="ReportePdf_VentaE_diaria.php" method="get">
<div class="control-group">
