...
$pdf->Cell(50, 8, '', 0);
$pdf->Cell(100, 8, 'REPORTE GENERAL DE VENTA "'.$verDesde.'"', 0);
$pdf->Ln(15);
...
$pdf->SetFont('Arial', '', 8);
//CONSULTA
$sql = mysql_query("SELECT numero_venta,serie_venta,fecha_venta, totpagar_venta,empleados_id from venta WHERE fecha_venta='$fechaini' ");
$item = 0;
//$totaluni = 0;
$totalventa = 0;
...
$pdf->Output('ReporteVentaG_diaria.pdf','I');
?>