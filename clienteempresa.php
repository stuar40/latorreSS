    ...
    <div class="span6">
      ...
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form id="clienteform" class="form-vertical" action="IngresarCliente.php" method="post"">
            
            <div class="control-group">
              <label class="control-label">Código de Empresa:</label>
              <div class="controls">
                <input name="codigo" type="text" class="span11" placeholder="Código de Empresa" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="nombreempresa" type="text" class="span11" placeholder="Nombre de la Empresa" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input name="direccion" type="text" class="span11" placeholder="Dirección" />
              </div>
            </div>
