...
<br>
<h2> REPORTE GENERAL DE VENTA MENSUAL</h2>
...
<table border="1" width="500" cellspacing="0" cellpadding="0">
  <tr>
    <td colspan="5" bgcolor="white"><CENTER><strong>REPORTE GENERAL DE VENTA MENSUAL</strong></CENTER></td>
  </tr>
  <tr bgcolor="skyblue">
...
<form class="form-horizontal" action="ReportePdf_VentaG_mensual.php" method="get">
<div class="control-group">
